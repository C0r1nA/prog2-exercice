...
public class Main {
    public static void main( String[] args ) {
        ...
        Teacher teacher1 = new Teacher(1, "Hanta", "Alice", LocalDate.of(1990, 2, 28), "hanta@gmail.com", "0312345678", Speciality.BACK-END);
        Teacher teacher2 = new Teacher(2, "Andria", "Mirija", LocalDate.of(1985, 12, 12), "mirija@gmail.com", "0318765432", Speciality.FRONT-END);

        Subject PROG2 = new Subject(1, "PROG2", 6, teacher1);

        Exam PROG2_Midterm = new Exam(1, "PROG2 Midterm", PROG2, LocalDate.of(2024, 10, 15), 2);
        Exam PROG2_Final = new Exam(2, "PROG2 Final", PROG2, LocalDate.of(2024, 12, 20), 3);
        ...
        Grade grade1 = new Grade(student1, PROG2_Midterm, 14.0);
        grade1.updateGrade(16.0, "Re-evaluation after rechecking");

        Grade grade2 = new Grade(student1, PROG2_Final, 12.0);
